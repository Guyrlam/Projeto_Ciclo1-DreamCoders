    ...
    const template =
        ...
        <section id="profile">
            <div id="profile-details">
                <div>
                    <img src="${data.image ?? '../../assets/no-pic-avatar.png'}" alt="imagem do perfil" id="profile-photo" name="editimagem">
                    <div id="change-photo">
                ...
                <div id="profile-description">
                    <h3 class="profile-details-text">
                        Nome: 
                        <input type="text" value="${data.name}" id="edit-username" class="inputs-edit-myprofile">
                    </h3>
                    <h3>
                        Descrição:
