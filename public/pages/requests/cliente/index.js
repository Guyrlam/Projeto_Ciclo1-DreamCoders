export default () => {
    ...
    <div id="page-requests">
        ...
        <div class="requests">
                <span class="name-type">Jorge Jesus : Troca de Livros!</span>
                <p>Olá, Mariana! Jorge Jesus deseja trocar o seu livro O Poder do HÁBITO por Sherlock Holmes: Um Estudo em Vermelho</p>
                <div>
